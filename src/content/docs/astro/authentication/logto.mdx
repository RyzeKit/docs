---
title: Logto
description: Logto authentication with RyzeKit.
---
import { Image } from 'astro:assets';

## Introduction

This starter kit provides [Logto](https://logto.io/) as an option for authentication, with [Lucia v3](https://v3.lucia-auth.com/) (the old version) as the middleman to connect Logto with Astro. Logto is a feature-rich 3rd-party authentication provider that supports multiple authentication methods, including email, password, OTP, and social providers.
