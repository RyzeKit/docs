...
7. Now in the home page of your Astro app, you can test authentication by clicking the **Sign Up** button and creating a new account. Once you have created an account, the app should redirect you to the dashboard page. Signing out should redirect you to the home page.
